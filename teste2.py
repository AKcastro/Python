...
df = pd.read_csv("c:/Users/akami/OneDrive/Área de Trabalho/vscode/Projeto/movies.csv")
...
# 5. Relação entre orçamento e receita
plt.figure()
...
# 6. Análise de lançamentos por ano
...
# 7. Avaliação média por gênero (simples)
